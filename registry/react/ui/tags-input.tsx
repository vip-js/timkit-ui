...
const tagsInputInputVariants = cva('flex-1 bg-transparent outline-none placeholder:text-muted-foreground')
...
>(({ className, value, defaultValue, onValueChange, disabled, name, editable, children, ...props }, ref) => {
...
>(({ className, index, value, children, ...props }, ref) => {
    ...
    return (
        ...
        >
            ...
            >
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-3 w-3" aria-hidden="true"><path d="M18 6 6 18" /><path d="m6 6 12 12" /></svg>
            </button>
