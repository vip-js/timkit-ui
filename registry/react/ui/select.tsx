...
const Select = (props: SelectProps) => {
    ...
    const service = useMachine(select.machine, {
        ...
        collection: props.listCollection || { items: props.items || [], itemToString: (item: any) => item.label || item, itemToValue: (item: any) => item.value || item },
...
const SelectTrigger = React.forwardRef<HTMLButtonElement, any>(({ className, children, asChild = false, ...props }, ref) => {
...
const SelectItem = React.forwardRef<HTMLDivElement, any>(({ className, children, item, ...props }, ref) => {
    const api = React.useContext(SelectContext)
