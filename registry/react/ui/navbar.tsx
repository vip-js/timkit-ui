...
const NavbarContent = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
    ({ className, ...props }, ref) => (
        <div ref={ref} data-slot="navbar-content" className={cn('flex h-16 items-center justify-between gap-4', className)} {...props} />
    )
)
...
const NavbarBrand = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
    ({ className, ...props }, ref) => (
        <div ref={ref} data-slot="navbar-brand" className={cn('flex items-center gap-2', className)} {...props} />
    )
)
...
const NavbarNav = React.forwardRef<HTMLElement, React.HTMLAttributes<HTMLElement>>(
    ({ className, ...props }, ref) => (
        <nav ref={ref} data-slot="navbar-nav" className={cn('flex items-center gap-4', className)} {...props} />
    )
)
...
const NavbarItem = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
    ({ className, ...props }, ref) => (
        <div ref={ref} data-slot="navbar-item" className={cn('flex items-center', className)} {...props} />
    )
)
...
const NavbarActions = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
    ({ className, ...props }, ref) => (
        <div ref={ref} data-slot="navbar-actions" className={cn('flex items-center gap-2', className)} {...props} />
    )
)
