  ...
  return (
    <div className="flex-none fixed inset-x-0 z-40 top-16 w-full xl:relative xl:max-w-[16rem] xl:top-0 xl:inset-x-[unset]">
      ...
      <aside className="relative w-full">
        <div
          className={`fixed inset-x-0 w-full h-full bg-zinc-950 px-4 border-r border-zinc-800 xl:inset-x-[unset] xl:block xl:max-w-[16rem] xl:top-auto xl:px-0 ${isOpen ? "" : "hidden"
            }`}
        >
