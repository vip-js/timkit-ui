import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, getCurrentInstance, inject, defineComponent, shallowRef, h, resolveComponent, computed, ref, Suspense, Fragment, createApp, provide, shallowReactive, unref, watch, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, defineAsyncComponent, mergeProps, getCurrentScope, toRef, withCtx, createTextVNode, isReadonly, useSSRContext, isRef, isShallow, isReactive, toRaw } from 'vue';
import { p as parseQuery$1, i as getContext, k as hasProtocol, f as joinURL, l as parseURL$1, m as encodePath$1, n as decodePath, w as withQuery, o as isScriptProtocol, q as withTrailingSlash, r as withoutTrailingSlash, s as sanitizeStatusCode, $ as $fetch, t as createHooks, c as createError$1, v as executeAsync, x as defu } from '../nitro/nitro.mjs';
...
const unhead_QydZogBCQCfDrwMZRUd0rSvba9ao1mtb0c6JSulUyAc = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const revive_payload_server_DDc7EoAUJgFr0E0_aEollgxToIlZ9g7QlabuRxwdbNU = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  unhead_QydZogBCQCfDrwMZRUd0rSvba9ao1mtb0c6JSulUyAc,
  plugin,
  revive_payload_server_DDc7EoAUJgFr0E0_aEollgxToIlZ9g7QlabuRxwdbNU,
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "docs-shell" }, _attrs))}><header class="docs-header"><div class="docs-container header-inner"><div class="brand"><div class="brand-mark" aria-hidden="true"></div><div class="brand-text"><div class="brand-title">TimUI</div><div class="brand-subtitle">Vue Documentation</div></div></div><nav class="header-actions">`);
  ...
  _push(`<a class="header-link" href="https://github.com" rel="noreferrer" target="_blank">GitHub</a></nav></div></header><main class="docs-main">`);
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/nuxt@3.21.1_@parcel+watcher@2.5.6_@types+node@25.2.3_@vue+compiler-sfc@3.5.28_cac@6.7.14_comm_eua2cdcf4myh6nqwx5f2x45jbe/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/nuxt@3.21.1_@parcel+watcher@2.5.6_@types+node@25.2.3_@vue+compiler-sfc@3.5.28_cac@6.7.14_comm_eua2cdcf4myh6nqwx5f2x45jbe/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { _export_sfc as _, __nuxt_component_0 as a, entry_default as default, tryUseNuxtApp as t, useRoute as u };
