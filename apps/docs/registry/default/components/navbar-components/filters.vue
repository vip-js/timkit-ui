...
<template>
  <div class="flex flex-col gap-4"><Popover><PopoverTrigger as-child><Button variant="outline" size="sm" class="text-sm"><ListFilterIcon :size="16" class="text-muted-foreground/80 -ms-1" aria-hidden="true" />Filters
          </Button></PopoverTrigger><PopoverContent class="w-36 p-3"><div class="space-y-3"><div class="text-xs font-medium">Filters</div><form><div class="space-y-3"><div class="flex items-center gap-2"><Checkbox :id="`${id}-1`" /><Label :htmlFor="`${id}-1`" class="font-normal">Real Time
