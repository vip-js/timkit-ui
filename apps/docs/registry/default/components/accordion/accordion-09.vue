...
import { ChevronDownIcon, Link2Icon, BellIcon, ShieldCheckIcon, LifeBuoyIcon } from 'lucide-vue-next'
...
<template>
  <div class="space-y-4">
    ...
    <Accordion type="single" collapsible class="w-full" default-value="3">
      ...
      >
        <div class="flex">
        <AccordionTrigger class="focus-visible:border-ring focus-visible:ring-ring/50 flex flex-1 items-center justify-between rounded-md py-2 text-left text-[15px] leading-6 font-semibold transition-all outline-none focus-visible:ring-[3px] [&[data-state=open]>svg]:rotate-180">
