...
<Dialog>
      ...
      <DialogContent class="flex flex-col gap-0 p-0 sm:max-h-[min(640px,80vh)] sm:max-w-lg [&>button:last-child]:top-3.5">
        ...
        <DialogFooter class="border-t px-6 py-4 sm:items-center">
