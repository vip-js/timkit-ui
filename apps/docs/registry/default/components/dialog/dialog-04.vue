...
<Dialog>
      ...
      <DialogContent class="flex flex-col gap-0 p-0 sm:max-h-[min(640px,80vh)] sm:max-w-lg [&>button:last-child]:hidden">
        <ScrollArea class="flex max-h-full flex-col overflow-hidden">
          <DialogHeader class="contents space-y-0 text-left">
            <DialogTitle class="px-6 pt-6">Frequently Asked Questions (FAQ)</DialogTitle>
