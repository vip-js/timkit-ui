...
<template>
  <div><div class="rounded-md border p-2"><Calendar mode="single" :selected="date" :onSelect="setDate" :month="month" :onMonthChange="setMonth" /><Button variant="outline" size="sm" class="mt-2 mb-1" @click="setMonth(today)">Current month
