...
<template>
<RadioGroup class="gap-2" defaultValue="1">
      
      <div class="border-input has-data-[state=checked]:border-primary/50 relative flex w-full items-start gap-2 rounded-md border p-4 shadow-xs outline-none">
        <RadioGroupItem
          value="1" id="radio-10-id" aria-describedby="radio-10-id-1-description"
        ...
        <div class="flex grow items-center gap-3">
          ...
          <div class="grid grow gap-2">
            <Label for="radio-10-id">
              Label 
              <span class="text-muted-foreground text-xs leading-[inherit] font-normal">
                (Sublabel)
              </span>
            </Label>
            <p id="radio-10-id" class="text-muted-foreground text-xs">
      ...
      <div class="border-input has-data-[state=checked]:border-primary/50 relative flex items-center gap-2 rounded-md border p-4 shadow-xs outline-none">
        <RadioGroupItem
          value="2" id="radio-10-id" aria-describedby="radio-10-id-2-description"
          class="order-1 after:absolute after:inset-0"
        />
