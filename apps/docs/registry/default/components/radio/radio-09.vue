...
<RadioGroup class="gap-2" defaultValue="1">
      ...
      <div class="border-input has-data-[state=checked]:border-primary/50 relative flex w-full items-start gap-2 rounded-md border p-4 shadow-xs outline-none">
        <RadioGroupItem
          value="1" id="radio-09-id" aria-describedby="radio-09-id-1-description"
          class="order-1 after:absolute after:inset-0"
        />
        <div class="flex grow items-start gap-3">
          <svg
            class="shrink-0" width="32" height="24"
            viewBox="0 0 32 24"
          ...
          <div class="grid grow gap-2">
            <Label for="radio-09-id">
              Label 
              <span class="text-muted-foreground text-xs leading-[inherit] font-normal">
                (Sublabel)
              </span>
            </Label>
            <p id="radio-09-id" class="text-muted-foreground text-xs">
      ...
      <div class="border-input has-data-[state=checked]:border-primary/50 relative flex w-full items-start gap-2 rounded-md border p-4 shadow-xs outline-none">
        <RadioGroupItem
          value="2" id="radio-09-id" aria-describedby="radio-09-id-2-description"
          class="order-1 after:absolute after:inset-0"
        />
        <div class="flex grow items-start gap-3">
          <svg
