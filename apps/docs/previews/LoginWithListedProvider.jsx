        ...
        <main className="w-full h-[800px] flex flex-col items-center justify-center px-4">
            <div className="max-w-sm w-full text-gray-600 space-y-8">
                ...
                <div className="space-y-4 text-sm font-medium">
                    <Button variant="outline" className="w-full flex items-center justify-center gap-x-3 py-2.5 hover:bg-gray-50 duration-150 active:bg-gray-100">
                ...
                <div className="text-center">
                    <Button variant="link" href="javascript:void(0)" className="text-indigo-600 hover:text-indigo-500 inline">Forgot password?</Button>
                </div>
            </div>
        </main>
    )
