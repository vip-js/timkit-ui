...
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogTrigger, DialogClose, DialogFooter } from "@timui/react";
                    ...
                    <div className="mt-3 sm:flex">
                        ...
                        <div className="mt-2 text-center sm:ml-4 sm:text-left">
                            ...
                            <DialogFooter className="items-center gap-2 mt-3 sm:flex">
                                <DialogClose className="w-full mt-2 p-2.5 flex-1 text-white bg-red-600 rounded-md outline-none ring-offset-2 ring-red-600 focus:ring-2">
                                    Delete
                                </DialogClose>
