            ...
            <div className="w-full space-y-6 text-gray-600 sm:max-w-md">
                <div className="text-center">
                    ...
                    <div className="mt-5 space-y-2">
                        ...
                        <p className="">Don't have an account? <Button variant="link" href="javascript:void(0)" className="font-medium text-indigo-600 hover:text-indigo-500 inline">Sign up</Button></p>
                    </div>
                </div>
                <div className="bg-white shadow p-4 py-6 space-y-8 sm:p-6 sm:rounded-lg">
                    <div className="grid grid-cols-3 gap-x-3">
                        <Button variant="outline" className="flex items-center justify-center py-2.5 hover:bg-gray-50 duration-150 active:bg-gray-100">
                        ...
                        <Button variant="outline" className="flex items-center justify-center py-2.5 hover:bg-gray-50 duration-150 active:bg-gray-100">
                            <svg className="w-5 h-5" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_910_21)">
                                    ...
                                    <path d="M11.0085 37.714C10.8614 37.8167 10.6111 37.714 10.472 37.5085C10.4335 37.4716 10.4029 37.4274 10.382 37.3785C10.3611 37.3297 10.3503 37.2771 10.3503 37.224C10.3503 37.1709 10.3611 37.1183 10.382 37.0694C10.4335 37.0205 10.619 36.8407 10.8694 36.9395C11.0085 37.141 11.1476 37.3425 11.0085 37.714Z" fill="#191717" />
                ...
                <div className="text-center">
                    <Button variant="link" href="javascript:void(0)" className="hover:text-indigo-600 inline">Forgot password?</Button>
                </div>
            </div>
        </main>
    )
