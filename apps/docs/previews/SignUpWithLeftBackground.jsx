        ...
        <main className="w-full flex">
            ...
            <div className="flex-1 flex items-center justify-center h-[700px]">
                <div className="w-full max-w-md space-y-8 px-4 bg-white text-gray-600 sm:px-0">
                    <div className="">
                        <img src="https://timkit-ui.com/logo.svg" width={150} className="lg:hidden" />
                    ...
                    <div className="grid grid-cols-3 gap-x-3">
                        <Button variant="outline" className="flex items-center justify-center py-2.5 rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100">
