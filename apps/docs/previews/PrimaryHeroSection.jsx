        ...
        <>
                ...
                <nav className="items-center pt-5 px-4 mx-auto max-w-screen-xl sm:px-8 md:flex md:space-x-6">
                    ...
                    <ul className={`flex-1 justify-between mt-12 md:flex md:mt-0 ${state ? '' : 'hidden'}`}>
                        <li className="order-2 pb-5 md:pb-0">
                            <Button className="py-3 px-6 block md:inline">
                                Sign In
                            </Button>
                        </li>
            ...
            <section className="mt-24 mx-auto max-w-screen-xl pb-4 px-4 sm:px-8">
                ...
                <div className="mt-12 justify-center items-center space-y-3 sm:space-x-6 sm:space-y-0 sm:flex">
                    <Button className="px-10 py-3.5 w-full sm:w-auto">
                        Get started
                    </Button>
                    <Button variant="outline" className="px-10 py-3.5 w-full sm:w-auto">
                        Try it out
                    </Button>
                </div>
            </section>
