...
import { DropdownMenu, DropdownMenuTrigger, DropdownMenuContent, DropdownMenuItem } from "@timui/react";
import { Tooltip, TooltipTrigger, TooltipContent, TooltipProvider } from "@timui/react";
export default function SidebarWithTooltip() {
  const navigation = [
    {
        ...
        <div className="flex flex-col h-full">
          <div className="h-20 flex items-center justify-center px-8">
            <a href="javascript:void(0)" className="flex-none">
              <img
                src="https://timkit-ui.com/logo-letter.png"
                width={35}
                className="mx-auto"
              />
            </a>
                  ...
                  <TooltipProvider delayDuration={0}>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <a
                          href={item.href}
                          className="relative flex items-center justify-center gap-x-2 text-gray-600 p-2 rounded-lg  hover:bg-gray-50 active:bg-gray-100 duration-150"
                        >
                          <div className="text-gray-500">{item.icon}</div>
                        </a>
                      </TooltipTrigger>
                      <TooltipContent className="absolute left-14 p-1 px-1.5 rounded-md whitespace-nowrap text-xs text-white bg-gray-800">
                        {item.name}
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
            ...
            <div>
              ...
              <div className="relative py-4 px-4 border-t">
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="mb-2 ml-10 w-64 rounded-lg bg-white shadow-md border text-sm text-gray-600 p-2" side="right" align="end" sideOffset={10}>
