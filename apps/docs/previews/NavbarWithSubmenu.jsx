...
export default function NavbarWithSubmenu() {
    ...
    const AvatarMenue = () => {
        ...
        return (
            <div className="relative border-t lg:border-none">
                <DropdownMenu>
                    <DropdownMenuTrigger className="hidden w-10 h-10 outline-none rounded-full ring-offset-2 ring-gray-200 lg:focus:ring-2 lg:block">
                        <img
                            src="https://api.uifaces.co/our-content/donated/xZ4wg2Xj.jpg"
                            className="w-full h-full rounded-full"
                        />
                    </DropdownMenuTrigger>
                    <DropdownMenuContent className="bg-white top-14 right-0 lg:absolute lg:border lg:rounded-md lg:w-52 lg:shadow-md">
                        {
    ...
    return (
        <header style={{ height: "400px" }} className="text-base lg:text-sm">
            <Navbar className={`bg-white items-center gap-x-14 px-4 max-w-screen-xl mx-auto md:px-8 lg:flex lg:static ${state ? "h-full fixed inset-x-0" : ""}`}>
                <NavbarContent className="flex items-center justify-between py-3 lg:py-5 lg:block">
                ...
                <NavbarNav className={`nav-menu flex-1 pb-28 mt-8 overflow-y-auto max-h-screen lg:block lg:overflow-visible lg:pb-0 lg:mt-0 ${state ? "" : "hidden"}`}>
