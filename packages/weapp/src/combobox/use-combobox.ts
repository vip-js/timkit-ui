import { comboboxMachine, comboboxConnect, comboboxCollection } from '@timui/core'
...
export function setupComboboxMachine(component: WeappComboboxComponent, context: WeappComboboxContext) {
