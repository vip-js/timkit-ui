import { toggleMachine, toggleConnect, type ToggleApi } from '@timui/core'
...
export function setupToggleMachine(component: WechatMiniprogram.Component.TrivialInstance, props: UseToggleProps): {
    service: object
    cleanup: () => void
    send: MachineSend
