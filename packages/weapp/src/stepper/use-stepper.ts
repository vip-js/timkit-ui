import { stepperMachine, stepperConnect, type StepperApi } from '@timui/core'
...
export function setupStepperMachine(component: WechatMiniprogram.Component.TrivialInstance, props: UseStepperProps): {
    service: object
    cleanup: () => void
    send: MachineSend
