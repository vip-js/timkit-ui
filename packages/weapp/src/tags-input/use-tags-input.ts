import { tagsInputMachine, tagsInputConnect, type TagsInputApi } from '@timui/core'
...
export function setupTagsInputMachine(component: WechatMiniprogram.Component.TrivialInstance, props: UseTagsInputProps): {
    service: object
    cleanup: () => void
    send: MachineSend
    ...
    return {
        ...
        connect: (state: object, send: MachineSend) =>
            tagsInputConnect(state, send) as TagsInputApi
    }
}
