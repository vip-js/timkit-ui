...
export const DropdownMenuContext: React.Context<DropdownMenuApi | null> = React.createContext<DropdownMenuApi | null>(null)
...
export const DropdownMenuProvider: React.Provider<DropdownMenuApi | null> = DropdownMenuContext.Provider
...
export function useDropdownMenuRadioGroupContext() {
    ...
    if (!context) {
        throw new Error('useDropdownMenuRadioGroupContext must be used within a DropdownMenuRadioGroup component')
    }
    return context
}
