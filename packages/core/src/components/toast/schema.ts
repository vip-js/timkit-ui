...
const toastSchema = defineUCS({
  name: 'toast',
  title: 'Toast',
  description: 'A succinct message that is displayed temporarily.',
  parts: [
    { name: 'root', description: 'The toast container', isRoot: true },
    { name: 'title', description: 'The toast title' },
    { name: 'description', description: 'The toast description' },
    { name: 'action', description: 'The toast action button' },
    { name: 'close', description: 'The toast close button' },
  ],
  logic: {
    provider: 'none',
  },
