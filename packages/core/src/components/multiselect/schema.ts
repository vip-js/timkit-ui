...
const multiselectSchema = defineUCS({
    name: 'multiselect',
    title: 'Multiselect',
    description: 'A component used to select multiple options from a list, often with searching and tagging capabilities.',
    parts: [
    ...
    slots: [
        { name: 'default', description: 'The multiselect core components' },
    ],
