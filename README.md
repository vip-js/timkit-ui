...
| 平台 | 状态 | 说明 |
| --- | --- | --- |
| React / Next.js | ✅ | 现有 `registry/default/ui` 与 `components/ui` 中的所有组件 |
| 微信小程序 | 🚧 | 新增 `packages/weapp` 渲染层，当前已提供 Button 原子组件示例，可按文档扩展 |
...
自 2025 年 2 月 25 日起，Timkit UI 已升级至 Tailwind CSS v4

> **注意**：组件将仅针对 Tailwind v4 进行开发
